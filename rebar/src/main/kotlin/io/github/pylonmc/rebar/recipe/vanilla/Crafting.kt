...
class ShapelessRebarRecipe @JvmOverloads constructor(
    ...
    override fun display() = Gui.builder()
        ...
        .addIngredient('1', inputs.getOrNull(1)?.button() ?: Item.EMPTY)
        .addIngredient('2', inputs.getOrNull(2)?.button() ?: Item.EMPTY)
        .addIngredient('3', inputs.getOrNull(3)?.button() ?: Item.EMPTY)
        .addIngredient('4', inputs.getOrNull(4)?.button() ?: Item.EMPTY)
        .addIngredient('5', inputs.getOrNull(5)?.button() ?: Item.EMPTY)
        .addIngredient('6', inputs.getOrNull(6)?.button() ?: Item.EMPTY)
        .addIngredient('7', inputs.getOrNull(7)?.button() ?: Item.EMPTY)
        .addIngredient('8', inputs.getOrNull(8)?.button() ?: Item.EMPTY)
