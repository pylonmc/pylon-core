...
class RebarItemSchema @JvmOverloads internal constructor(
    ...
    fun place(context: BlockCreateContext): RebarBlock? {
        ...
        if (BlockStorage.isRebarBlock(context.block)) { // special case: you can place on top of structure void blocks
            return null
        }
        return BlockStorage.placeBlock(context.block, rebarBlockKey, context)
    }
