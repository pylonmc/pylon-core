...
object DisplayRecipeType : RecipeType<PylonRecipe>(pylonKey("display")) {
    override fun loadRecipe(key: NamespacedKey, section: ConfigSection): PylonRecipe {
        throw UnsupportedOperationException("DisplayRecipeType does not support loading recipes from config")
    }
}