...
import io.github.pylonmc.rebar.block.PylonBlock.Companion.isVanillaBlock
...
internal class FluidPipePlacementTask(
    ...
    private fun tick() {
        ...
        if (player.gameMode != GameMode.CREATIVE && !playerHasEnoughPipes) {
            ...
            isValid = false
            player.sendActionBar(Component.translatable("pylon.pyloncore.message.pipe.not_enough_pipes"))
            ...
            isValid = false
            player.sendActionBar(Component.translatable("pylon.pyloncore.message.pipe.cannot_place_here"))
            display.setItemStack(ItemStack(Material.RED_CONCRETE))
            ...
            // Everything is fine
            isValid = true
            player.sendActionBar(Component.translatable("pylon.pyloncore.message.pipe.connecting"))
