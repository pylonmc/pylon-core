...
import io.github.pylonmc.rebar.event.PylonBlockDeserializeEvent
import io.github.pylonmc.rebar.event.PylonBlockSerializeEvent
...
open class PylonBlock internal constructor(val block: Block) {
     ...
     *
     * This is necessary because "external" stuff like [PylonGuiBlock], [io.github.pylonmc.rebar.block.base.PylonFluidBufferBlock]
     ...
     * a [io.github.pylonmc.rebar.block.base.PylonFluidBufferBlock], you must use this
     ...
     * groups (see [io.github.pylonmc.rebar.block.base.PylonLogisticBlock]).
     *
     * Called before [postLoad], after [io.github.pylonmc.rebar.event.PylonBlockPlaceEvent],
     * after [PylonBlockDeserializeEvent], and
     * before [io.github.pylonmc.rebar.event.PylonBlockLoadEvent]
     */
     ...
     * Instead, implement [io.github.pylonmc.rebar.block.base.PylonUnloadBlock] and
     * use [io.github.pylonmc.rebar.block.base.PylonUnloadBlock.onUnload].
     */
    ...
    companion object {
        ...
        @JvmStatic
        val pylonBlockTextureEntityKey = rebarKey("pylon_block_texture_entity")

        @JvmStatic
        val pylonBlockKeyKey = rebarKey("pylon_block_key")

        @JvmStatic
        val pylonBlockPositionKey = rebarKey("position")
