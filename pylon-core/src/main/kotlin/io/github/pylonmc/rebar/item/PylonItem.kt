...
import io.github.pylonmc.rebar.i18n.PylonTranslator.Companion.translator
    ...
    companion object {
        ...
        private fun checkName(schema: PylonItemSchema) {
            ...
            if (name == null || name.key() != ItemStackBuilder.nameKey(schema.key)) {
                Rebar.logger.warning("Item ${schema.key}'s name is not a translation key; check your item uses PylonItemStackBuilder.of(...)")
                isNameValid = false
            }
